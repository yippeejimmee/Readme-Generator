...
//this function will take the input and return a badgelink that corresponds to that badge
...
function generateMarkdown(data) {
  //stores that license property of the data and stores it in the badge
  let badge = renderLicenseBadge(data.license)

  //returns the markdown of the README folder
  return `
  # ${data.title}
